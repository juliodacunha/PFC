...
$consulta = $link->query("SELECT nome, sobrenome, telefone, email, sexo, bairro, rua, numero, complemento, id_passageiro 
from usuarios, passageiros, enderecos 
where id_usuario = id_usuario_id and id_passageiro = id_passageiro_id") or die ($link->error);
...
while($dado = $consulta->fetch_array()){
    ...
    $result = mysqli_query($link, $descobrir_id);
...
<div class="text-center mt-5">
    ...
    <form method="post">
        <button class="btn btn-primary" role="button"><a style="color: white;" href="../paginas/passageiro_pelomot.php" style="text-decoration: none;">Não, desejo voltar</a></button><br>
