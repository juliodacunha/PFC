...
$sql = $conexao->query("SELECT nome, sobrenome, rua, numero, bairro, complemento, cidade, cep, telefone, email, cpf, rg FROM usuarios, passageiros, enderecos WHERE id_usuario = id_usuario_id AND id_motorista_id = '$id_motorista' AND id_passageiro = id_passageiro_id ") or die ($conexao->error);
?>
<html lang="en">
<head>
