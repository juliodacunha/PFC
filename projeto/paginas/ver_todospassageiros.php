...
if($tipo_usuario == 2){
    ...
    if(isset($_GET['mes'])){
      ...
      and tipuser_tip_user = tip_user and descricao = 'passageiro' and id_usuario = id_usuario_id and id_passageiro = id_passageiro_id") or die ($conexao->error);
      ...
      $consulta5 = $conexao->query("SELECT id_usuario, nome, sobrenome, telefone, email, sexo, bairro, rua, numero, complemento, id_passageiro, id_motorista_id, telefone
      from usuarios, passageiros, enderecos, corridas
      where id_usuario = id_usuario_id and id_passageiro = id_passageiro_id and id_usuario = usuario_id_usuario and data_corrida = '$data' and horario_volta = 'Nao volta'") or die ($conexao->error);
